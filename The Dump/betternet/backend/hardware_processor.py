...
h5_raw = h5py.File(r'C:\Users\zande\PycharmProjects\ANL2025\betternet\data\2025-06-23-15-51-28-odmr_hardware_2mT\seq0\eval\odmr.h5', 'r')
quick_raw = h5py.File(r'C:\Users\zande\PycharmProjects\ANL2025\betternet\data\2025-06-23-15-51-28-odmr_hardware_2mT\scalarData.h5', 'r')
data = np.asarray(h5_raw['data'])
quick_data = np.asarray(quick_raw['data'])
initial_params = [-1e3, 2824000000, 1e6, 1, 1]
print(quick_data[20, 20])
...
# print(fit_params)
plt.scatter(spectra[20,20]/1e9, counts[20,20], color='red')
